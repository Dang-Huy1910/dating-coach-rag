def test_bio_rewrite_golden(client, stub_hits, monkeypatch):
    monkeypatch.setattr(
        ...
        lambda _prompt: '{"reply": "Bỏ khẩu hiệu chung, thêm việc bạn làm cuối tuần.", "improved_draft": "Cuối tuần mình hay đi chợ hoa rồi nấu phở. Tìm người cà phê cuối tuần, không vội.", "openers": null, "analysis_points": ["Khẩu hiệu chung", "Thiếu chi tiết cuối tuần", "Thêm lời mời nhẹ"]}',
    )
